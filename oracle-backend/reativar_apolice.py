...
def reativar_apolice():
    print("🔁 Reativação de Apólice")
    policy_id = int(input("Digite o ID da apólice que deseja reativar: "))

    payload = f"reativarApolice@{h(policy_id)}"
    ...
    print(f"✅ Apólice reativada com sucesso. Hash: {tx_hash}")
